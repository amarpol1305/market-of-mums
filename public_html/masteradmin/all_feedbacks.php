				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-madison">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-doc"></i>All Feedback Details
							</div>
						</div>
						...
						<?php foreach($feedbacks as $f){ ?>	
							<tr>
								...
								<td>
                                                                    <a href="view_feedback.php?id=<?php  echo $f['id'];?>"><img src="img/editgrid.png"></a> | <a href="javascript:confirmChoice('<?php echo $lid;?>')"><img src="img/deletegrid.png"></a>
								</td>
							</tr>
						<?php } ?>
							</tbody>
